 ...
 * target queue (either as {@link Queue} reference or as queue name).
 *
...
public class JmsInvokerClientInterceptor implements MethodInterceptor, InitializingBean {
	...
	/**
	 * Resolve the given queue name into a JMS {@link Queue},
	 ...
	 * using a {@link TemporaryQueue} for receiving the response.
