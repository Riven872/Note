...
public abstract class AbstractAdaptableMessageListener
	 ...
	 * @see #setDefaultResponseDestination(Destination)
	 */
	 ...
	 * to handle {@link BytesMessage BytesMessages},
	 ...
	 * @throws JMSException if thrown by JMS API methods
	 * @see Message#setJMSCorrelationID
	 */
	 ...
	 * delegates it to {@link #extractMessage(Message)} in order to enforce
