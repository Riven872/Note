 ...
 * Can either host a standard JMS {@link MessageListener} or Spring's
...
public abstract class AbstractMessageListenerContainer extends AbstractJmsListeningContainer
	...
	/**
	 * Return whether the Publish/Subscribe domain ({@link Topic Topics}) is used
	 * for replies. Otherwise, the Point-to-Point domain ({@link Queue Queues})
	 * is used.
	 * @since 4.2
	 */
	@Override
