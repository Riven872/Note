...
public class JmsInvokerServiceExporter extends RemoteInvocationBasedExporter
	 ...
	 * @throws JMSException in case of message access failure
	 */
	@Nullable
	 ...
	 * @throws JMSException if creating the message failed
	 */
	 ...
	 * @throws JMSException in case of the invalid request supposed
