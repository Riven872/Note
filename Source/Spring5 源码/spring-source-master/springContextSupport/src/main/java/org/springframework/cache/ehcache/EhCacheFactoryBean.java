...
/**
 * {@link FactoryBean} that creates a named EhCache {@link Cache} instance
 * (or a decorator that implements the {@link Ehcache} interface),
 * representing a cache region within an EhCache {@link CacheManager}.
 *
...
public class EhCacheFactoryBean extends CacheConfiguration implements FactoryBean<Ehcache>, BeanNameAware, InitializingBean {
	...
	/**
	 * Set an EhCache {@link BootstrapCacheLoader}
	...
	/**
	 * Specify EhCache {@link CacheEventListener cache event listeners}
