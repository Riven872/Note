...
/**
 * Base class that can be used to implement a standard {@link Encoder}
 * and/or {@link Decoder}. It provides encode and decode method
 ...
 * both of {@link Encoder} and {@link Decoder}.
...
public abstract class ConvertingEncoderDecoderSupport<T, M> {
	 ...
	 * @see Encoder#init(EndpointConfig)
	 * @see Decoder#init(EndpointConfig)
	 */
	 ...
	 * @see Encoder.Binary#encode(Object)
	 */
	 ...
	 * @see Decoder.Binary#willDecode(ByteBuffer)
	 */
	 ...
	 * @see Decoder.Binary#decode(ByteBuffer)
	 */
	@SuppressWarnings("unchecked")
	@Nullable
	...
	/**
	 * A binary {@link Binary javax.websocket.Encoder} that delegates
	...
	/**
	 * A binary {@link Encoder.Binary javax.websocket.Encoder} that delegates
	 * to Spring's conversion service. See {@link ConvertingEncoderDecoderSupport} for details.
	...
	/**
	 * A text {@link Text javax.websocket.Encoder} that delegates
	...
	/**
	 * A Text {@link Encoder.Text javax.websocket.Encoder} that delegates
	 * to Spring's conversion service. See {@link ConvertingEncoderDecoderSupport} for details.
	 * @param <T> the type that this Decoder can convert from
	 */
