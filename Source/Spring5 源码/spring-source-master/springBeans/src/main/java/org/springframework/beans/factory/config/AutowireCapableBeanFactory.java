 ...
 */
/*xxx: 具有自动注入功能的bean容器  （附带创建bean，bean后置处理器的特性）*/
public interface AutowireCapableBeanFactory extends BeanFactory {
	 ...
	 * @see #autowireBeanProperties
	 */
	/*xxx: 将具有给定名称的bean定义的属性值应用于给定的bean实例*/
	 ...
	 * @see #getBean(Class)
	 */
	/*xxx: 解析唯一匹配给定对象类型（如果有）的bean实例，包括其bean名称。*/
	 ...
	 */
	/*xxx: 解析给定bean名称的bean实例，为暴露于目标工厂方法提供依赖描述符*/
