...
public interface WebApplicationContext extends ApplicationContext {
	 ...
	 */
	/*xxx:  成功启动时要将根WebApplicationContext绑定到的上下文属性*/
	 ...
	 */
	/*xxx: 除了标准作用域“singleton”和“prototype”外，还支持request作用域的标识符*/
	 ...
	 * Supported in addition to the standard scopes "singleton" and "prototype".
	 */
	/*xxx: 除了标准作用域“singleton”和“prototype”外，还支持session作用域的标识符*/
	 ...
	 * Supported in addition to the standard scopes "singleton" and "prototype".
	 */
	/*xxx: 除了标准作用域“singleton”和“prototype”外，还支持application作用域的标识符*/
